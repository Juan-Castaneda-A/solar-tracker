...
def sun_position(time):
    """
    Toma la marca de tiempo de la imagen del cielo
    Devuelve la posición del sol (x, y) en coordenadas cartesianas, y una máscara binaria del sol.
    Para la explicación del método, consulta la Figura 7 de nuestro artículo https://doi.org/10.1063/5.0014016
    o la Figura 4 en el README de este repositorio.
    """
